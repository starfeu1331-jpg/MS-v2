        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 border-b border-zinc-800 flex items-center justify-center">
            {sidebarOpen ? (
              ...
              <img src="/Logo%20Magic%20Système.png" alt="Logo" className="object-contain" style={{ height: '32px', width: '32px', minHeight: '28px', minWidth: '28px', maxHeight: '40px', maxWidth: '40px' }} />
            )}
          </div>

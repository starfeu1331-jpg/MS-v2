    ...
    return (
      <div className="space-y-6">
        ...
        <div className="glass rounded-3xl p-8 skel-breath skel-d3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">{[0,1,2,3].map(i => <div key={i} className="h-24 bg-zinc-808/40 rounded-xl border border-zinc-800" />)}</div>
        </div>
      </div>
    )
  }
    ...
    <div className="space-y-6 fade-in">
      ...
      <div className="glass rounded-3xl p-8 border border-zinc-800">
        ...
        <div className="flex gap-2">
          <button
            onClick={() => { setChannel('all'); trackFilter('forecast', { channel: 'all' }) }}
          ...
          <button
            onClick={() => { setChannel('mag'); trackFilter('forecast', { channel: 'mag' }) }}
            className={`px-4 py-2 rounded-xl font-semibold transition-all ${
              channel === 'mag'
          ...
          <button
            onClick={() => { setChannel('web'); trackFilter('forecast', { channel: 'web' }) }}
            className={`px-4 py-2 rounded-xl font-semibold transition-all ${
              channel === 'web'

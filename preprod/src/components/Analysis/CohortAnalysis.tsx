      ...
      <div className="space-y-6">
        <div className="glass rounded-3xl p-8 skel-breath">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div><div className="h-7 w-48 bg-zinc-800 rounded-lg mb-2" /><div className="h-3.5 w-64 bg-zinc-800/60 rounded-md" /></div>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[0,1,2,3].map(i => <div key={i} className={`rounded-xl p-4 border border-zinc-800 bg-zinc-800/30 skel-breath skel-d${i+1}`}><div className="h-3 w-16 bg-zinc-700 rounded mb-2" /><div className="h-6 w-20 bg-zinc-700/60 rounded" /></div>)}
          </div>
        </div>
        <div className="glass rounded-3xl p-8 skel-breath skel-d2">
          <div className="h-5 w-36 bg-zinc-800 rounded-lg mb-4" />
          <div className="space-y-3">{[0,1,2,3,4,5].map(i => <div key={i} className="h-10 bg-zinc-800/40 rounded-lg" />)}</div>
        </div>
      </div>
    )
  }

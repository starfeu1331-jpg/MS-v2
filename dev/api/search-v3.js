...
export default async function handler(req, res) {
  ...
  try {
    ...
    const hasCategoryFilters = famille || sous_famille || sous_sous_famille
    ...
    if (hasCategoryFilters) {
      ...
      // Top familles (pour la page d'accueil catégories sans filtre)
      let topFamilles = []
      if (!famille && !sous_famille && !sous_sous_famille) {
        topFamilles = await prisma.$queryRawUnsafe(`

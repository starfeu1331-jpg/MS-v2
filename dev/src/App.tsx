...
import { BarChart3, Search, Home, Users, Settings, Menu, X, Package, ShoppingBag, Store, Activity, Download, Target, Layers, Globe, Crown, Megaphone, Calendar, ChevronDown, Map, MoreHorizontal, Shield, LogOut } from 'lucide-react'
...
type TabType = 'dashboard' | 'search' | 'rfm' | 'subFamilies' | 'crossSelling' | 'cohortes' | 'abc' | 'kingquentin' | 'zones' | 'stores' | 'forecast' | 'social' | 'exports' | 'settings' | 'admin'
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="mobile-content flex-1 overflow-y-auto bg-zinc-950">
          <Suspense fallback={<LoadingFallback />}>
            ...
            {page === 'search' && <div className="p-6"><SearchPanel /></div>}
            ...
            {page === 'admin' && <div className="p-6"><AdminUsers /></div>}
          </Suspense>
        </main>
      </div>
